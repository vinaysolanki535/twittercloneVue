<template>
  <div id="app" class="flex container h-screen w-full">
    ...
    >
      <div>
        <button
          class="h-12 w-12 hover:bg-lightblue text-3xl rounded-full text-blue iconButton"
        >
        ...
        <div>
          <button
            ...
            @click="id = tab.id"
            v-bind:key="tab"
            :class="`focus:outline-none hover:text-blue flex items-center py-2 px-4 hover:bg-lightblue rounded-full mr-auto mb-3 iconListColor ${
              id === tab.id ? 'iconList' : ''
            }`"
          >
